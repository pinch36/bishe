...
policy_keep = ['Random', 'DotProd', 'Clustering', 'Packing', 'BestFit', 'FGD','FGDPredictor']
policy_keepr = ['FGD','FGDPredictor', 'BestFit', 'Packing', 'Clustering', 'DotProd', 'Random']
...
if TYPE=='alloc':
    ...
    hue_order=policy_keep,palette=colors, linestyle='--')
